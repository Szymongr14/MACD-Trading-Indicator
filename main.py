...
final_alternative_capital_WIG20 = simulate_alternative_strategy(WIG20_data_frame, start_units)
...
print("WIG20 Actions after using MACD based strategy: {}%".format(round(final_capital_WIG20 / start_units * 100), 2))
print("UAXUSD Actions after using MACD based strategy: {}%".format(round(final_capital_UAXUSD / start_units * 100), 2))
